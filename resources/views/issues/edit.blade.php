    ...
    <div class="mx-auto max-w-7xl space-y-4">
        <section class="page-banner animate-fade-in">
            <div class="page-banner-content">
                <span style="display: inline-flex; align-items: center; gap: 6px; padding: 4px 10px; background: var(--trackit-primary-soft); color: var(--trackit-primary); border-radius: 999px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 12px;">
                    <i class="bi bi-pencil"></i>
                    Edit issue
                </span>
                <h1 style="margin: 0 0 8px; font-size: 28px; font-weight: 700; color: var(--trackit-text);">
                    Update this issue
                </h1>
                <p style="margin: 0; font-size: 14px; color: var(--trackit-muted); line-height: 1.5;">
            ...
            <div class="page-banner-meta">
                <div class="meta-tile">
                    ...
                    <div class="meta-tile-value" style="font-size: 14px;">{{ ucfirst(str_replace('_', ' ', $issue->status)) }}</div>
                    <div style="font-size: 10px; color: var(--trackit-muted); margin-top: 2px;">Current</div>
                </div>
                <div class="meta-tile">
                    <div class="meta-tile-label">Updated</div>
                    <div class="meta-tile-value" style="font-size: 14px;">{{ $issue->updated_at->format('M d') }}</div>
                    <div style="font-size: 10px; color: var(--trackit-muted); margin-top: 2px;">Recently</div>
                </div>
            </div>

            <div class="page-banner-actions">
                <a href="{{ route('issues.show', $issue) }}" class="btn btn-secondary" style="display: inline-flex; align-items: center; gap: 6px; font-size: 14px; padding: 6px 12px;">
